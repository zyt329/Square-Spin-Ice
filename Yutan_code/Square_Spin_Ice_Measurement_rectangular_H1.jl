...
function driver(;L1::Int64, L2::Int64, h_vals, J2)
    ...
    for i in 1:length(h_vals)
        ...
        println("Constructing H1 for h=$(h), J2=$(J2) finished, Lanczos starting.")
        eigstate1 = eigsolve(H1, 1, :SR, eltype(H1), tol = 10^(-12))[2][1]
        println("Lanczos for h=$(h), J2=$(J2) finished")
...
L1=4; L2=6; h_vals = range(0.01, 0.5, length = 50); J2_vals = range(0, 2, length = 10)
for J2 in J2_vals
